...
public class GUIProductListings2 extends JPanel  implements ActionListener {
	...
	public GUIProductListings2() throws IOException {
		 
        List<JButton> storeName = new ArrayList<>();
        btnBack = new JButton("Go Back");
        middlePanel.setBackground(new Color(210, 105, 30));
