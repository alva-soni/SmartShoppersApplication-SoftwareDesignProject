...
public class GUIProductManagement2 extends JPanel implements ActionListener {
	...
	public GUIProductManagement2() throws IOException {

		
		this.setBackground(new Color(210, 105, 30));
		storeName = new JLabel("<html><u>" + Store.getStoreName(Manager.getManagerStoreID(Manager.managerLoggedIn), "data/Stores.txt") + "</html></u>");
		...
		btnBack.setBounds(150, 277, 107, 23);
		...
		lblNewLabel.setBounds(81, 42, 328, 14);
	...
	public void addComponents() {	
		...
		btnNewProduct.setForeground(new Color(240, 255, 255));
		btnNewProduct.setBackground(new Color(0, 100, 0));
		...
		lblNewLabel_5 = new JLabel("Manager Privileges");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblNewLabel_5.setBounds(175, 67, 113, 14);
		add(lblNewLabel_5);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		//shop by category
			...
			try {
				...
				mainFrame.frame.getContentPane().add(new GUIProductListings2());
			...
			
		{
			...
			Products.categoryChosen = "";
			GUIProductListings2.searched = "PRODUCTS ON SALE";
			try {
			...
			try {
				...
				mainFrame.frame.getContentPane().add(new GUIAddProduct2());
			} catch (IOException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}
