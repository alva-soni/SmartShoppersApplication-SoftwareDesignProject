...
public class GUIProductListings extends JPanel  implements ActionListener {
	...
	public GUIProductListings() throws IOException {
		 
        List<JButton> storeName = new ArrayList<>();
        btnBack = new JButton("Go Back");
        middlePanel.setBackground(new Color(135, 206, 250));
